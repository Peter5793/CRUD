/*
# CREATED Peter Lugalia (Credits go to bpwebs.com)
...
function globalVariables(){ 
  var varArray = {
    spreadsheetId   : '1luaAWf11z0WhMnP_xeU73sZqp7nnIWmjPa-hxz9MlX4', //** CHANGE !!!
    dataRage        : 'Data!A2:T',                                    //** CHANGE !!!
    idRange         : 'Data!A2:T',                                    //** CHANGE !!!
    lastCol         : 'T',                                            //** CHANGE !!!
    insertRange     : 'Data!A1:T1',                                   //** CHANGE !!!
...
/* ADD OR REMOVE VARIABLES ACCORDING TO YOUR FORM*/
  if(formObject.RecId && checkID(formObject.RecId)){
    var values = [[formObject.RecId.toString(),
                  formObject.name,
                  formObject.gender,
                  formObject.dateOfPayment,
                  formObject.email,
                  formObject.phone,
                  formObject.bundlephone,
                  formObject.serviceProvider,
                  formObject.personalProfile,
                  formObject.amountPaid,
                  formObject.status,
                  formObject.category,
                  formObject.transactionCode,
                  formObject.dateofSecondPayment,
                  formObject.amountPaid2,
                  formObject.transactionCodeII,
                  formObject.dateofThirdPayment,
                  formObject.amountPaid3,
                  formObject.transactionCodeIII]];
